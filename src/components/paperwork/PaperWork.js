    ...
    if (this.state.documents === null) {
      ...
      return (
        ...
        >
          <Grid item>
            <img
              src={require("../../assets/no-paperwork-image.png")}
              alt={"No PaperWork"}
              className="no-paperwork-image"
            />
          </Grid>
          <Grid item>
            <Box marginTop={-3} marginLeft={4}>
              <Typography className="paperwork-heading reallos-text">
                Paperworks
              </Typography>
            </Box>
          </Grid>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: 18 }}>
                ...
                <p>This action is not undoable. Think again...</p>
              </div>
            </div>
      ...
      <div>
        <Container>
          ...
          >
            ...
            >
              <ArrowUpIcon className="fab-icon" size={20} /> &nbsp; Upload
              Document
            </Fab>
          </Grid>
        </Container>
